...
-- Listage des données de la table forum_jn.post : ~3 rows (environ)
INSERT INTO `post` (`id_post`, `creationDate`, `text`, `user_id`, `topic_id`) VALUES
	(1, '2023-04-28 11:58:49', 'TestPost', 1, 1),
	(2, '2023-04-28 11:59:55', 'blabla TESt2', 1, 1),
	(3, '2023-04-28 14:43:54', 'blablablablablablablavpeokrepo krpokepok', 1, 2);
...
-- Listage des données de la table forum_jn.topic : ~5 rows (environ)
INSERT INTO `topic` (`id_topic`, `title`, `creationDate`, `closed`, `user_id`, `category_id`) VALUES
	(1, 'TEST', '2023-04-28 09:43:10', 0, 1, 1),
	(2, 'TEST2', '2023-04-28 10:01:23', 0, 1, 1),
	(3, 'voiture de courses', '2023-04-28 16:12:26', 0, 1, 2),
	(4, 'Basket', '2023-04-28 16:12:52', 0, 1, 3),
	(5, 'tracteurs', '2023-04-28 16:13:42', 0, 1, 2);
...
-- Listage des données de la table forum_jn.user : ~0 rows (environ)
INSERT INTO `user` (`id_user`, `pseudo`, `password`, `inscriptionDate`, `role`) VALUES
	(1, 'testtttUSER', 'test', '2023-04-28 09:42:48', 'USER');
